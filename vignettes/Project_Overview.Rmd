...
shinyApp(ui <- fluidPage( #create embedded ShinyApp
  ...
  titlePanel("Monthly Deciles Index (11/01/2019 - 03/31/2020)"), #set page title
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      sliderInput(inputId = "slider", label = "Monthly", min = 1, max = 5, value = 1) #set interactive slider options. 
    ),
