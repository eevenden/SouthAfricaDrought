...
The NOAA Drought Index is also a precipitation based index. This index utilizes weekly precipitation data for the time interval of interest. In this case, the mean precipitation for an eight-week interval is calculated and then compared with the subsequent ninth week. If the ninth week is greater than 60% of the precipitation, it's classified as having little to no water stress. An area is considered no longer stressed once the rainfall returns to 60% or more. 
